...
function Author() {
    ...
    function Signin(login: string, password: string) {
        axios.post("https://back.cintoes.link/auth/signin", {
            email: login,
            password: password
        }).then(res => {
            setError("");
            ...
            if (DecodeB64(res.data.jwt).isVerified == "false")
                axios.get("https://back.cintoes.link/verify/send", {headers: {Authorization: "Bearer " + res.data.jwt}})
                    .then(resp => {
                        nav("../ver")
                    })
                    .catch(err => {
    ...
    const signIn = useGoogleLogin({
        onSuccess: (resp) => {
            axios.post("https://back.cintoes.link/auth/google",
                ...
                <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <span className={"flex flex-col "}>
                        ...
                        <FacebookLogin
                            ...
                            onSuccess={(response) => {
                                axios.post("https://back.cintoes.link/auth/facebook",
