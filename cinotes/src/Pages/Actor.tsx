...
export function Actor(){
    ...
    return (
        <div style={{background:"repeating-linear-gradient(45deg, rgba(0, 255, 255, 1), rgba(0, 255, 255, 1) 1px, rgba(44, 44, 44, 1) 11px, rgba(64, 64, 64, 1) 200px)"}} className={"min-h-screen h-auto  flex flex-col pb-10 text-white bg-neutral-800"}>
            <HomeHeader/>
