...
export function FilmInPlaylist(film: any, pl_pk: string) {
    const pk=film.id
    console.log(film)
    return (
        <div className="flex mx-5 my-5  justify-end">
            <svg id={"svg"+pk.toString()} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
            ...
            <Link id={"front"+pk.toString()} to={`/films/${film.film.url.split("/")[4]}`}
                  style={{
    ...
    function tryDelete() {
        //@ts-ignore
        document.getElementById("back"+pk.toString()).style.visibility = "visible"
        //@ts-ignore
        document.getElementById("back"+pk.toString()).style.width = "260px"
        //@ts-ignore
        document.getElementById("front"+pk.toString()).style.visibility="collapse"
        //@ts-ignore
        document.getElementById("front"+pk.toString()).style.width="0px"
        //@ts-ignore
        document.getElementById("svg"+pk.toString()).style.visibility="collapse"
        //@ts-ignore
        document.getElementById("svg"+pk.toString()).style.width="0px"
    }
    function getBack(){
        //@ts-ignore
        document.getElementById("back"+pk.toString()).style.visibility = "collapse"
        //@ts-ignore
        document.getElementById("back"+pk.toString()).style.width = "0px"
        //@ts-ignore
        document.getElementById("front"+pk.toString()).style.visibility="visible"
        //@ts-ignore
        document.getElementById("front"+pk.toString()).style.width="260px"
        //@ts-ignore
        document.getElementById("svg"+pk.toString()).style.visibility="visible"
        //@ts-ignore
        document.getElementById("svg"+pk.toString()).style.width="40px"
    }
    function Delete(){
