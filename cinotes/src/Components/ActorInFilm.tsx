...
export function ActorInFilm(actor:any){
    return(
        <>
            <div className={"hover:bg-gray-900 flex shadow-gray-900 flex-col bg-neutral-800 rounded-xl border-2 border-stone-900 shadow-lg w-44 h-72 hover:shadow-white mx-5 my-5"}>
