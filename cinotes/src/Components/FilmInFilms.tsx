...
export function FilmInFilms(film:any){
            return(
                <>
                    <div className={"hover:bg-gray-900 flex shadow-gray-900 flex-col bg-neutral-800 rounded-xl border-2 border-stone-900 shadow-lg w-64 h-96 hover:shadow-white mt-10 ml-10 "}>
